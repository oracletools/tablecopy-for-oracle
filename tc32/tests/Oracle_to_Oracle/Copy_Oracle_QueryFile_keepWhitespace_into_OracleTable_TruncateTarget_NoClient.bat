::Test name: Oracle_QueryFile keepWhitespace
	::Description:	Read SQL from a query file "C:\Python27\data_migrator_1239\test\v101\query\oracle_query.sql".Copy Oracle query results into OracleTable TruncateTarget NoClient.
	::Arguments:
...
python -c "print 'y\ny'" |C:\Python27\tc_dist_32\20150111_052504\tc32\tc32.exe ^
-w ora2ora ^
-o 1 ^
-r 1 ^
-t "|" ^
